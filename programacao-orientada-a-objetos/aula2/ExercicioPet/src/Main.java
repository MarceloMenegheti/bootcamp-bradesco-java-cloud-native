...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
		    ...
		    System.out.println("9 - Ligar a máquina");
		    ...
		    case 7 -> setPetInMaquine();
		    case 8 -> petMachine.removePet();
		    case 9 -> petMachine.washMachine();
		    case 0 -> System.exit(0);
		    default -> System.out.println("Opticao invalida! ");
	...
	private static void checkIfHasPetInMachine() {
		var hasPet = petMachine.HasPetInMachine();
		System.out.println(hasPet ? "Tem pet na maquina! " : "Nao tem pet na maquina! ");
		
	}

	public static void setPetInMaquine(){
		var name = "";
		...
		System.out.print("O pet  "+ pet.getName()+ " foi colocado na maquina! ");
	}
